Readme for CoE3DQ5 Project Software Model 2017
...
encode_all:
This encodes the .ppm file to a .mic11 file (McMaster Image Compression, revision 10).
...
decode_m3:
This is a reference for milestone 3 in hardware. The .mic11 file is lossless decoded
